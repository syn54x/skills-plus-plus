...
- **[adhd](./adhd/SKILL.md)**: The shortest useful answer: the point first, at most three bullets, then stop.
- **[eli5](./eli5/SKILL.md)**: A plain-language explanation with one everyday analogy.
