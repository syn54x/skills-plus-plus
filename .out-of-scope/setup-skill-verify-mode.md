# Verify/Check Mode for `setup-syn54x-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-syn54x-skills`.
...
- #106: Feature request: verify/check mode for setup-syn54x-skills
