...
| The agent's last message re-pitched because it didn't land | [wait-what](../productivity/wait-what.md) |
| To sharpen thinking you already have, rather than acquire new material | [grill-me](../productivity/grill-me.md) |
| A background agent to read primary sources and leave you a cited document | [research](../engineering/research.md) |
| To learn something that came up mid-grilling, without derailing the grilling | [handoff](../productivity/handoff.md) out to a teaching workspace, then `teach` there |
...
Its one real neighbour is [handoff](../productivity/handoff.md), through the composition Matt named as the answer to "what do I do if I'm being grilled about something I don't understand?": don't stop the grilling to learn: `/handoff` to a teaching workspace, learn it there with `/teach`, then go back and pick up where you left off. The nearby alternative is [research](../engineering/research.md), for when what you want is a cited document rather than lessons and retention. When you are not sure which skill or flow fits, [ask-syn54x](../engineering/ask-syn54x.md) routes you over the whole set.
