...
| --- | --- |
| Your own head, unsharpened | [grill-me](../productivity/grill-me.md) |
...
Its neighbour is [grill-me](../productivity/grill-me.md), and the two split on where the answers live: grilling mines you, a questionnaire mines someone else. What comes back is raw material: feed it into another grilling round, or into [grill-with-docs](../engineering/grill-with-docs.md) or [to-spec](../engineering/to-spec.md) if the work is heading for a build. When you're unsure which skill fits the moment, [ask-syn54x](../engineering/ask-syn54x.md) routes you.
