...
Step 1 depends on `docs/agents/issue-tracker.md`, which [setup-syn54x-skills](https://github.com/syn54x/skills-plus-plus/blob/main/docs/engineering/setup-syn54x-skills.md) writes. Without it the axis still works if you hand it a path. With no spec at all, the Spec sub-agent is skipped and the report says "no spec available" rather than inventing requirements.
...
[ask-syn54x](https://github.com/syn54x/skills-plus-plus/blob/main/docs/engineering/ask-syn54x.md) routes across the whole set when you are unsure which skill the situation wants.
