...
You will also arrive here without choosing to. [wayfinder](../engineering/wayfinder.md) files `prototype` decision tickets on its map, and working one is this skill.
